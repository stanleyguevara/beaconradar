...
public abstract class BasePreferenceFragment<V extends MvpView, P extends MvpPresenter<V>>
        extends PreferenceFragmentCompat implements BaseMvpDelegateCallback<V, P> {
